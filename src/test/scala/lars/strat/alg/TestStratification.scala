...
class TestStratification extends FunSuite {
  ...
  test("strat 3") {
    ...
    val nodes3 = Set[ExtendedAtom](x1,x2,y1,y2,z1,z2,w)
...
//    val set_w = sccs(w)
    ...
    val expITA = Map[Int,Set[ExtendedAtom]](
      0 -> Set(z1,z2,y2), 1 -> Set(y1,w), 2 -> Set(x1,x2)
    )
  ...
  test("strat 6") {
    ...
    val edges = Set[DepEdge[ExtendedAtom]](e(a,c,geq),e(b,a,geq),e(b,d,geq),e(d,c,grt))
